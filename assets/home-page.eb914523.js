import{e as a,l as r,s as p,G as n,S as c,Y as s,J as o,u as m,M as u,N as h,o as x,r as f}from"./index.287afb74.js";const b=a(()=>s({class:"mt-10 flex items-center justify-start gap-x-4 px-6 pb-6 border-b"},[o({href:"/docs",class:"bttn primary"},"Get started"),o({href:"https://github.com/chrisdurfee/base",target:"_blank",class:"bttn ghost gap-2"},"Github")])),g=a(({title:t,description:e})=>r({class:"flex flex-col px-6"},[f({class:"text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]"},t),e&&n({class:"max-w-2xl text-lg font-light text-foreground mt-2"},e)])),w=a(({title:t,description:e})=>r({class:"flex flex-col"},[p({class:"scroll-m-20 text-2xl font-bold tracking-tight"},t),e&&n({class:"text-base text-muted-foreground py-2 max-w-[700px]"},e)])),i=a(({title:t,description:e},d)=>m({class:"flex flex-col w-full px-6 py-8 border-b"},[w({title:t,description:e}),d])),k=a((t,e)=>s({class:"flex flex-auto flex-col"},[s({class:"flex flex-auto flex-col w-full max-w-[1400px] m-auto sm:pt-8 lg:border-r lg:border-l"},[g({title:"Build faster with Base and Tailwind CSS",description:"Beautifully designed components inpired by the genius at Shadcn and tailored to work with Base. Base is easy to use and open source."}),b(),...e])])),l=a((t,e)=>u({...t,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer mt-4 ${t.class}`},[h({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(e[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:x.clipboard.checked})}},e)])),y=()=>new c([k([i({title:"Why Base?",description:"Base is a small framework that does things like global and local states, routing, events, dates, data tracking, data binding, data watching, and rending of components using Atoms. It is designed to be simple and fast to build. It's open source and in npm."},[l("npm install @base-framework/base"),s({class:"mt-10 flex items-center justify-start gap-x-4 pb-6"},[o({href:"https://github.com/chrisdurfee/base/wiki",target:"_blank",class:"bttn ghost gap-2"},"Base Docs")])]),i({title:"Example App",description:"This is an example Todo app built with base."},[l(`import { Button, Div, Form, H1, Input, Li, Ul } from "@base-framework/atoms";
